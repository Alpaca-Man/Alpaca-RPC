...
/**
 * 解码器, 将ByteBuf转码成AlpacaResponse, 步骤:
 * ByteBuf -> 反序列化 -> AlpacaResponse
 *
 * @author Mr.Alpaca
 * @version 1.0.2
 */
public class AlpacaByteToResponseDecoder extends ByteToMessageDecoder {
    private final AlpacaSerializer serializer;

    public AlpacaByteToResponseDecoder(AlpacaSerializer serializer) {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        AlpacaResponse response = serializer.deserialze(AlpacaResponse.class, content);
        list.add(response);
    }
}
